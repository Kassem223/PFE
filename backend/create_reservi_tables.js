...
async function createReserviTables() {
  try {
    console.log('=== Création des tables dans reservi_db ===');
    ...
    try {
      ...
      console.log('Base de données reservi_db prête !');

      // Vérifier les tables créées
      const [tables] = await conn.execute('SHOW TABLES');
      console.log('\nTables disponibles:', tables.map(t => t[0]));
